...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == 0) {
        ...
        [cell setTitle:[NSString stringWithFormat:@"负责人:%@",self.curPro.responsible.name] subtitle:[NSString stringWithFormat:@"职称:%@",self.curPro.responsible.professional] value:self.curPro.responsible.avatar];
        return cell;
